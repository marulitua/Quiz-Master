...
RSpec.describe Question, type: :model do
  ...
  context 'when the answer is in string' do
  ...
  context 'when the answer is in number' do
    describe '#guess with user\'s input in number' do
      it 'returns true if equal' do
    ...
    describe '#guess with user\'s input in words' do
      it 'returns true if equal' do
